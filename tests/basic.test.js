...
describe('Comparaciones en Javascript', () => {
    ...
    //});
        const expresion = number === 10; // Esto será false
        expect(expresion).toBeFalsy();
});
    it("usando !==", () => {
    ...
    //});
//});
        const expresion = language !== "Javascript"; // Esto será false
        expect(expresion).toBeFalsy();
    });
});
...
describe('Algebra booleana', () => {
    ...
    //});
        const b = true; // Para que la expresión sea verdadera
        const expression = a && b;
        expect(expression).toBeTruthy();
    });
    ...
    //});
//});
        const b = false; // Para que la expresión sea falsa
        const expression = a || b;
        expect(expression).toBeFalsy();
    });
});
